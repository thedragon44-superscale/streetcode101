...
# Force load environment variables so Alembic uses your production credentials
load_dotenv()

# Add the parent directory to the path so we can import your backend modules
